...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    ...
    <a href="{{ route($routePrefix . '.competitions.create') }}" class="btn-primary btn-sm">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-5 py-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="{{ route($routePrefix . '.competitions.edit', $c->id) }}" class="p-1.5 rounded-lg text-slate-400 hover:text-[#2563EB] hover:bg-blue-50 transition-colors" title="Edit">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            </a>
                            <form action="{{ route($routePrefix . '.competitions.destroy', $c->id) }}" method="POST" onsubmit="return confirm('Hapus lomba ini?')">
                                @csrf @method('DELETE')
                ...
                <tr>
                    <td colspan="7" class="px-5 py-12 text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <a href="{{ route($routePrefix . '.competitions.create') }}" class="text-xs text-[#2563EB] hover:underline font-semibold mt-1">+ Tambah Lomba Pertama</a>
                        </div>
                    </td>
                </tr>
                @endforelse
