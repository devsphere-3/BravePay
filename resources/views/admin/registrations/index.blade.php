        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    <td class="px-5 py-4">
                        <a href="{{ route('admin.registrations.show', $reg->id ?? $reg->order_code) }}" class="font-mono text-xs font-bold text-[#2563EB] hover:underline">{{ $reg->order_code ?? '—' }}</a>
                    </td>
                    <td class="px-5 py-4">
                    ...
                    <td class="px-5 py-4 text-center">
                        <a href="{{ route('admin.registrations.show', $reg->id ?? $reg->order_code) }}"
